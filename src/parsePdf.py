...
#Find file in directory(in this repo, this should bne sufficient but you may need to change based on yours)
cwd = Path.cwd()

filename = cwd / "src" / Path("Full version of CEH report, master file.pdf")
